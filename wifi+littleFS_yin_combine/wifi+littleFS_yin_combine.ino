...
void updateDisplay() {
  ...
  display.drawFastVLine(centerX, gaugeY - 4, 5, SSD1306_WHITE);
  display.drawFastVLine(centerX - 50, gaugeY - 2, 3, SSD1306_WHITE);
  display.drawFastVLine(centerX + 50, gaugeY - 2, 3, SSD1306_WHITE);
  display.drawFastHLine(centerX - 50, gaugeY, 100, SSD1306_WHITE);
